...
{
    public class BinanceWalletApi : ApiToolsBase, IWalletApi
    {
        public BinanceWalletApi(PrivateApiWebClient apiWebClient) : base(apiWebClient)
        {
        }
        ...
        public async Task<Response<IDictionary<string, IBalance>>> GetCompleteBalancesAsync()
        {
            ...
            var response = jsonResult.AsObject<BinanceUserInfo>().Map<BinanceUserInfo>();
